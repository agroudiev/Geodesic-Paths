...
\coordinate (S00) at (1,2);
\coordinate (S10) at (3,2);
\coordinate (S01) at (1+4.3,2);
\coordinate (S11) at (3+4.3,2);
...
\fill[teal, opacity=0.4] (S10) -- (1.5,0) -- (3.5,0) -- cycle;
...
\fill[color=purple] (S00) circle (0.05) node[left] {$p_0$};
\fill[color=teal] (S10) circle (0.05) node[right] {$p_1$};

\fill[purple, opacity=0.4] (S01) -- (0.5+4.3,0) -- (2.0+4.3,0) -- cycle;
\fill[teal, opacity=0.4] (S11) -- (2.0+4.3,0) -- (3.5+4.3,0) -- cycle;
...
\fill[color=purple] (S01) circle (0.05) node[left] {$p_0$};
\fill[color=teal] (S11) circle (0.05) node[right] {$p_1$};