...
A first natural approach could be to consider the graph formed by the vertices and edges of the mesh, and run Dijkstra's algorithm on it. However, this would only yield paths that follow the edges of the mesh, which can be arbitrarily longer than the true geodesic paths on the surface.
...
\begin{figure}
	...
	\caption{Illustration of a window $w=(s, p, e, b_0, b_1, d_0, d_1, \sigma)$.}
	\Description{}
