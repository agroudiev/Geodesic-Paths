...
\begin{abstract}
	...
	We also provide from-scratch implementations of \textcolor{red}{TODO} methods, namely the heat method, fast marching, and the Improved Chen-Han algorithm, and compare their performances on several datasets.
	\todo{list all methods}
...
After brief mathematical reminders in \autoref{sec:math-reminders}, we present \textcolor{red}{TODO} methods based on the resolution of Partial Differential Equations (PDEs) in \autoref{sec:pde-methods}.
\todo{number of methods}
...
this comes at the cost of stability when considering angles that are too small.
...
A solution to this exists but might not terminate due to its non-locality.\todo{référence de ça?}
...
In this section, we present experiments and results obtained from our implementations of the heat method, fast marching, and the Improved Chen-Han algorithm.\todo{add other methods}
