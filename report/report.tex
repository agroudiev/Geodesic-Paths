...
\begin{figure}
	...
	\end{tikzpicture}
	\caption{Illustration of a window $w=(s, p, {\color{blue}e}, {\color{red}b_0}, {\color{red}b_1}, {\color{teal}d_0}, {\color{teal}d_1}, \sigma)$.}
	\Description{}
...
\begin{figure}[ht]
	...
	\end{tikzpicture}
	\caption{Illustration of the ``one angle, one split'' pruning rule: \textcolor{red}{TODO}}
	\Description{}
...
\begin{figure}[ht]
	...
	\end{tikzpicture}
	\caption{Windows are redudant and can be trimmed if \textcolor{red}{TODO}}
	\Description{}
