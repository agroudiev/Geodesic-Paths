...
\begin{figure}[ht]
	...
	\caption{Benchmark of the time complexity of the \emph{Heat method} on various 3D meshes, as a function of the number of vertices. \textcolor{red}{TODO: add line to fit the second part}}
	\Description{}
...
\begin{figure}[ht]
	...
	\caption{$\ell^{2}$ error of the spectral embedding on $k$ vectors to the full spectral embedding.
		...
		$\nv$ used for the embedding size. \textcolor{red}{TODO: increase font size in figure (decrease figsize in matplotlib), decrease points size}}
	\Description{}
...
It is also worth noting that ICH is the only algorithm to natively support path reconstruction; this can be done for some PDE-based methods at the cost of additional work. \todo{\@ matthieu tu peux préciser ça si besoin}
